    ...
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        <h1 className="text-5xl md:text-7xl font-bold mb-6">
          <span className="bg-gradient-to-r from-[#33C3F0] to-[#0FA0CE] bg-clip-text text-transparent">
            co.alt
          </span>
          <br />
          <span className="bg-gradient-to-r from-[#33C3F0] to-[#0FA0CE] bg-clip-text text-transparent text-4xl md:text-5xl">
            AI LAB
          </span>
        </h1>
